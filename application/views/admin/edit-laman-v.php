...
<div style="margin-top: 14px; background-color: white;padding: 30px">
	<h5 class="text-info">Edit Laman</h5><hr/>
			...
			<div class="col-md-4">
				...
				<div class="form-group">
					...
					<select class="form-control" name="s_laman">
						...
						<?php else: ?>
							<option value="<?php echo $detail->s_laman; ?>">-- <?php echo $this->Admin_m->detail_data_order('laman','id_laman',$detail->s_laman)->judul_laman; ?> --</option>
						<?php endif ?>
